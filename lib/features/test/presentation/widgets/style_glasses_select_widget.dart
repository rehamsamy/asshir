...
class StyleGlassesSelectWidget extends StatefulWidget {
  ...
  const StyleGlassesSelectWidget({required this.height, required this.width, required this.onSelected, required this.items});
  @override
  _StyleGlassesSelectWidgetState createState() => _StyleGlassesSelectWidgetState();
}
