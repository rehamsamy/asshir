...
class ItemProductFavoriteWidget extends StatefulWidget {
  ...
  @override
  _ItemProductFavoriteWidgetState createState() => _ItemProductFavoriteWidgetState();
}
...
class _ItemProductFavoriteWidgetState extends State<ItemProductFavoriteWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    double height = widget.height ?? globalSize.setHeightPercentage(60, context);

    var priceAfterDiscount = (widget.product!.price ?? 0.0) - (widget.product!.discountPrice ?? 0.0);

    return Container(
      // width: width,
      // height: height,
      // color: globalColor.red,
      padding: EdgeInsets.only(left: utils.getLang() == 'ar' ? 0.0 : EdgeMargin.verySub, right: utils.getLang() == 'ar' ? EdgeMargin.verySub : 0.0),
      child: InkWell(
        onTap: () {
          print('click');
                                    ...
                                    child: widget.product!.type != 1
                                        ? Container(
                                            ...
                                            padding: const EdgeInsets.fromLTRB(
                                                EdgeMargin.verySub, EdgeMargin.verySub, EdgeMargin.verySub, EdgeMargin.verySub),
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        _buildPriceWidget(price: widget.product!.price!, discountPrice: priceAfterDiscount.toString()),
                                        VerticalPadding(
                                          percentage: 0.5,
                                        ),
                                        Container(
                                          child: RichText(
                                            ...
                                            strutStyle: StrutStyle(fontSize: textSize.middle),
                                            maxLines: 2,
                                            text: TextSpan(
          ...
          discountPrice.isNotEmpty
              ? Container(
                  ...
                  child: RichText(
                    text: TextSpan(
                      text: discountPrice,
                      style: textStyle.middleTSBasic.copyWith(fontWeight: FontWeight.bold, color: globalColor.primaryColor),
                      children: <TextSpan>[
                        new TextSpan(
                            text: ' ${Translations.of(context).translate('rail')}', style: textStyle.smallTSBasic.copyWith(color: globalColor.black)),
                      ],
                    ),
                  ),
                ))
                  ...
                  child: RichText(
                    text: TextSpan(
                      ...
                      style: textStyle.middleTSBasic
                          .copyWith(fontWeight: FontWeight.bold, decoration: TextDecoration.lineThrough, color: globalColor.grey),
                      children: <TextSpan>[
                        TextSpan(
                            text: ' ${Translations.of(context).translate('rail')}', style: textStyle.smallTSBasic.copyWith(color: globalColor.grey)),
                      ],
                    ),
                  ),
                ))
